...
<html lang="en" style="height: 100%">
    <head>
        ...
        <link rel="stylesheet" href="/static/CACHE/css/06bfdea50a3e.css" type="text/css" media="screen" />
        <link rel="stylesheet" href="/static/CACHE/css/a5c0829f431b.css" type="text/css" /><link rel="stylesheet" href="/static/CACHE/css/2c191bb09ae8.css" type="text/css" media="screen" />

        <!-- Le javascript -->
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "rbG0XIfv8VwpBESdlvv9yzu1zYwqCkqqK1J0dAPFgAV54oNlZ7IoX2n6rp0z8QKr";
        </script>
        <script type="text/javascript" src="/static/CACHE/js/fa705b4d7fe1.js"></script>
        

        <script type="text/javascript" src="/static/CACHE/js/9c3946e0f628.js"></script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type='hidden' name='csrfmiddlewaretoken' value='rbG0XIfv8VwpBESdlvv9yzu1zYwqCkqqK1J0dAPFgAV54oNlZ7IoX2n6rp0z8QKr' />
    <table>
...
<p class="form-group">
  <input type="text" name="auth-username" maxlength="100" id="id_auth-username" autocapitalize="off" autocorrect="off" required placeholder="Username or email address" class="form-control" tabindex="1" />
  <span class="help-block">
    No account? <a href="/pricing/" id="id_signup_link">Sign up here!</a>
  </span>
</p>
<p class="form-group">
  <input type="password" name="auth-password" id="id_auth-password" required placeholder="Password" class="form-control" tabindex="2" />
  <span class="help-block">
...
<div class="clear"></div>
  ...
  <footer id="id_copyright_div" class="footer">
    <p>
      Copyright &copy; 2011-2019 <a href="/about/company_details/">PythonAnywhere LLP</a>
      &mdash;
