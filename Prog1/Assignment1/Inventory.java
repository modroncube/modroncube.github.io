 ...
 * you need to determine how to create an instance of this inventory and invoke the
 * methods it provides as needed when implementing your Sales System
...
public class Inventory
{
   ...
   private final String[] productIDs = { "P1",
                                         "P2",
                                         "P3",
                                         "P4",
                                         "P5",
   ...
   private final String[] productDescriptions = { "Lego City Garbage Truck",
                                                  "Moana Adventure Doll",
                                                  "Grafix Mega Craft Jar - Pink",
                                                  "Rusty Rivets Rusty Botasaur",
                                                  "Scrabble Original Board Game",
                                                  "Jungle Pals Baby Playmat" };

   // Fixed array storing prices for products in inventory.
   private final double[] productPrices = { 28.00,
                                            50.00,
                                            17.99,
                                            56.99,
                                            50.00,
   ...
   private final int[] productStockLevels = { 8,
                                              6,
                                              5,
                                              2,
                                              1,
    ...
    * 
    * NOTE: The new Inventory object will include a starting image of the
    * products in inventory.
    * 
    * @param companyName
    *           The name of the company for which inventory is being managed.
    */
    ...
    * 
    * @param productID
    *           The ID of the product for which a description is being
    *           retrieved.
    * 
    ...
    * 
    * @param productID
    *           The ID of the product for which a price is being retrieved.
    * 
    * @return The price for the corresponding product if the specified product
    *         ID was found, or Double.NaN if the specified product ID was not
    *         found.
    */
    ...
    *           retrieved.
    * 
    * @return The current stock level for the corresponding product if the
    *         product ID is found, or -1 if the specified product ID was not
    *         found.
    */
    ...
    *           retrieved.
    * @param quantity
    *           The quantity of the product being removed from Inventory.
    *           Quantity must be > 0 or request to remove stock from Inventory
    *           will be rejected.
    * 
    * @return -1 if the product ID is invalid; or -2 if quantity is invalid (<=
    *         0); or -3 if the quantity exceeds the current stock level; or the
    *         stock level remaining if stock level was updated successfully.
    */
    ...
    * 
    * @param productID
    *           the product ID for which an index position is required.
    * 
